...
features_test = sc.transform(features_test)         # here we only use transform not fit_transform

print(features_train.mean(axis=0))
print(features_train.std(axis=0))          #mean of each variable is now around zero and the standard deviation is set to 1
